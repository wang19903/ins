<template>
  <div class="postItem">
    <img :src="post.image" @click="$store.dispatch('showPostDetails', post.id)" alt="" width="100%" height="100%"
    ...
    <div class="postInfo">
      <div class="postMeta">
        ...
        <PostActions :likes="post.liked_bies" :comments="post.comments" :favors="post.favored_bies"
          :likedByMe="post.likedByMe" :favoredByMe="post.favoredByMe" @likeClick="$store.dispatch('toggleLike', post.id)"
